...
import com.refresh.smart.cn.view.CustomRefreshFooter;
 ...
 * @Date on 2018/08/13.
 * @org 上海相舆科技有限公司
 * @describe  防美团下拉刷新  上拉加载
 */


public class PullMoreAndRefreshActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pull_more_meitu);
        ...
        refreshLayout.setRefreshHeader(new CustomRefreshHeader(mContext));
         refreshLayout.setRefreshFooter(new CustomRefreshFooter(mContext, "加载中…"));
